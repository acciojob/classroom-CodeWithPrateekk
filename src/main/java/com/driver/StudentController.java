...
public class StudentController {
    ...
    public ResponseEntity<String> addStudent(@RequestBody Student student){
        ...
        String newStudent = studentService.addStudent(student);
    ...
    public ResponseEntity<String> addTeacher(@RequestBody Teacher teacher){
        String newTeacher = studentService.addTeacher(teacher);
...
//
    ...
    public ResponseEntity<String> deleteTeacherByName(@RequestParam String teacher){
        ...
        return new ResponseEntity<>(s + " removed successfully", HttpStatus.CREATED);
    }
    @DeleteMapping("/delete-all-teachers")
    public ResponseEntity<String> deleteAllTeachers(){

        String s = studentService.deleteAllTeachers();
